...
<?php echo $this->Form->postLink('<i class="icon-trash icon-white"></i> Kontaktaufnahme löschen', array('action' => 'delete', $cooperation['Cooperation']['id']), array('class' => 'btn btn-danger', 'escape' => false), 'Bist du dir sicher, dass du die Kontaktaufnahme löschen willst? Das kann nicht rückgängig gemacht werden.'); ?>

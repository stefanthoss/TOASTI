...
<table class="table table-condensed span6">
	...
	<tr><td>Kontaktperson:</td><td><?php echo $cooperation['Cooperation']['contact_id']; ?></td></tr>
	<tr><td>Veranstaltung:</td><td><?php echo $cooperation['Cooperation']['event_id']; ?></td></tr>
	<tr><td>VWI-Mitglied:</td><td><?php echo $cooperation['Cooperation']['user_id']; ?></td></tr>
